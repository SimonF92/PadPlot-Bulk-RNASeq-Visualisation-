...
def volcano():
    ...
    sds = Scale(master, from_=0, to=50,resolution=5,orient=HORIZONTAL,variable=var3).grid(row=4,column=2)
...
def main_gui():
    ...
    Button(root, text='Choose a folder to save plots to',command=get_figure_path).grid(row=2, column=2,padx=20, pady=20)
